package day7_javastream.labassignment;
...
public class CopyOfDemoBookCaseStudyProblem {
    ...
    private static List<Book> loadAllBooks() {
        ...
        List<Author> authors1 = Arrays
                .asList(new Author("Royal", "Gondane",
                                "in", Arrays.asList("in","usa","aus")),
                        new Author("Sumukha", "Udupa", "in",
                                Arrays.asList("in","usa")));

        List<Author> authors2 = Arrays.asList
                (new Author("Royal1", "Gondane1", "in",Arrays.asList("in","usa","aus"))
                );

        List<Author> authors3 = Arrays
                .asList(new Author("Nikhil", "Sawadh",
                                "us",Arrays.asList("in","usa","china")),
                        new Author("Ashish", "Sirsat", "us"
        ...
        books.add(new Book("Management", authors3, 600, Subject.DOT_NET, 2000, "1293"));
